...
function PANEL:Init()
	...
	self.buybutton:SetFont("Arial32")
	self.buybutton:SetText("  Buy car")

	self.buybutton.DoClick = function() 
			if LocalPlayer():GetNWInt("money") < VEHICLE_DB[self.ID].Price then GAMEMODE.Notify("Not enough money") return end
